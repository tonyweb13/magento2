...
class Interceptor extends \Temando\Shipping\Block\Adminhtml\Sales\Order\View\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExtShipment');
        if (!$pluginInfo) {
            return parent::getExtShipment();
        } else {
            return $this->___callPlugins('getExtShipment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasExtShipment');
        if (!$pluginInfo) {
            return parent::hasExtShipment();
        } else {
            return $this->___callPlugins('hasExtShipment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExtShipmentId');
        if (!$pluginInfo) {
            return parent::getExtShipmentId();
        } else {
            return $this->___callPlugins('getExtShipmentId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormattedDestinationAddress');
        if (!$pluginInfo) {
            return parent::getFormattedDestinationAddress();
        } else {
            return $this->___callPlugins('getFormattedDestinationAddress', func_get_args(), $pluginInfo);
        }
    }
