...
class Interceptor extends \Magento\Wishlist\Block\Catalog\Product\View\AddTo\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getWishlistOptionsJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWishlistOptionsJson();
        } else {
            return $this->___callPlugins('getWishlistOptionsJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWishlistParams()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWishlistParams();
        } else {
            return $this->___callPlugins('getWishlistParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isWishListAllowed()
    {
        ...
        if (!$pluginInfo) {
            return parent::isWishListAllowed();
        } else {
            return $this->___callPlugins('isWishListAllowed', func_get_args(), $pluginInfo);
        }
    }
